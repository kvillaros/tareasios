...
//  tarea1
//
//  Created by Kristel Villalobos on 2/9/16.
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    //     CREAMOS O REUTILIZAMOS LA CELDA, dequeueReusableCellWithIdentifier = VERIFICA SI NECESITA CREAR UNA NUEVA CELDA SINO DEVUELVE UNA EXISTENTE QUE NO SE ESTE UTILIZANDO
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"Cell" forIndexPath:indexPath];
    cell.textLabel.text = [NSString stringWithFormat:@"%ld",(long)indexPath.row];
    
    if ([self isPrime:indexPath.row]){
